    ...
    <>
      <div className="d-flex justify-content-center">
        <div className="row wrap-social">
          <div className="social facebook mb-3" style={{backgroundColor: "#1976d2"}}>
          ...
          <div className="social google mb-3" style={{backgroundColor: "#fefefe"}}>
            <a href="storeman1311@gmail.com" style={{color: "#000"}}>
              <img alt="google" src={"/assets/icon/google.png"} width="30" height="30" className="me-3"/>
              <span>Google</span>
            </a>
          </div>
          <div className="social telegram mb-3" style={{backgroundColor: "#26a5e5"}}>
          ...
          <div className="social github mb-3" style={{backgroundColor: "#fefefe"}}>
